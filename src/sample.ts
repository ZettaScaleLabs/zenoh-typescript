...
export function congestion_control_from_int(prio_u8: number): CongestionControl {
    switch (prio_u8) {
        case 0:
...
export function congestion_control_to_int(congestion_control: CongestionControl): number {
...
export function Sample_from_SampleWS(sample_ws: SampleWS) {
    ...
    let congestion_control = congestion_control_from_int(sample_ws.congestion_control);
    ...
    return Sample.new(key_exr, payload, sample_kind, encoding, priority, timestamp, congestion_control, express, attachment);

}

export function SampleWS_from_Sample(sample: Sample, encoding: Encoding, priority: Priority, congestion_control: CongestionControl, express: boolean, attachement: Option<ZBytes>): SampleWS {
    ...
    let sample_ws: SampleWS = {
        key_expr: key_expr, value: value, kind: sample_kind,
