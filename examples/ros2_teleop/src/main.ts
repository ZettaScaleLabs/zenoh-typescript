...
// const lidar_subscriber = async function (sample: Sample): Promise<void> {
//   console.log("Received sample: " + sample);
//   let reader = new jscdr.CDRReader(dcodeIO.ByteBuffer.fromBase64(sample.payload()));
...
//   ctx.stroke();
// }
// session.declare_subscriber(key_expr, lidar_subscriber)
